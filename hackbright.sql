...
3	Testing	How to test if your code work	60
\.
...
COPY public.students (id, first_name, last_name, gitbut) FROM stdin;
1	Jane	Hacker	jhacks
2	Sarah	Developer	sdevelopers
\.
